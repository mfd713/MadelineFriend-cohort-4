...
namespace CapsuleHotel
{
    public static class ConsoleIO
    {
       ...
       public static void StartupMenu()
        ...
        /// </summary>
        /// <param name="hotel">List of Capsules</param>
        public static void ViewGuestList(List<Capsule> hotel)
        {
            if (hotel.Count == 0)
            {
                Console.WriteLine("No guests to view yet!");
            ...
            centerIndex = ReadInt($"Please enter the capsule you wish to view (1 - {hotel.Count})", 1, hotel.Count) - 1;
            ...
            //add center
            AddToViewList(hotel, centerIndex, content);

            //add 5 to the right if there are...
            if (hotel.Count - 5 - 1 >= centerIndex)
            {
            ...
            if (hotel.Count - 5 - 1 < centerIndex)
            {
                for (int i = centerIndex + 1; i < hotel.Count; i++)
                {
                    AddToViewList(hotel, i, content);
                }
            }
        ...
        /// </summary>
        /// <param name="hotel">string array full of guest names</param>
        /// <param name="i">index you want in the array</param>
        /// <param name="sBuild">a string builder that you are adding to</param>
        static void AddToViewList(List<Capsule> hotel, int i, StringBuilder sBuild)
        {
            ...
            {
                sBuild.Append($"\n{i + 1}: {hotel[i].Occupant.FirstName} {hotel[i].Occupant.LastName}");
            }
        }
